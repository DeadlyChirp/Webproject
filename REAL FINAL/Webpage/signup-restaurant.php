...
<head>
    ...
    <style>
        body{
            background-image: url("../background/pixel-city-chill.gif");
        }
    </style>
</head>
<body>
<div class="container">
    ...
    <form action="../INCLUDES-files/signup.inc.restau.php" method="post">
...
<!--        POURQUOI METHOD POST? Car on veut pas que les datas soient visibles sur le URL/LIEN-->
        <div class="form-content">
            ...
            <div class="signup-form">
                <div class="title">Sign-Up as a Professional</div>
                <div class="input-boxes">
                    <div class="input-box">
                        <i class="fas fa-address-card"></i>
                        <input placeholder="Name of the restaurant" name="name" type="text">
                    </div>
                    ...
                    <div class="input-box">
                        <i class="fas fa-envelope"></i>
                        <input placeholder="Enter the adress" name="adresse" type="text">
                    </div>
                    <div class="input-box">
                        <i class="fas fa-envelope"></i>
                        <input placeholder="Enter the city" name="ville" type="text">
                    </div>
...
<!--                        <input class="fa" type="submit" value="Sign-Up">-->
                    ...
                    <div class="text log-in-text">Already have an account? <a href="login-restaurant.php"> Log in as a Pro now!:D</a></div>
                    <div class="text sign-up-text">Log in as an<a href="login.php"> User</a></div>
