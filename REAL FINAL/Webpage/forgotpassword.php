            ...
            <div class="login-form">
                ...
                <div class="input-boxes">
                    ...
                    <div class="input-box">
                        ...
                        <input placeholder="Enter your Email to reset your password" name="email" type="text">
                    </div>
                    <?php
                    require_once '../INCLUDES-files/dbhandler.inc.php';
                    if (isset($_POST["forgotpassword"])){
                        $email = $connection->real_escape_string($_POST["email"]);
                        $data = $connection->query("SELECT usersId FROM users WHERE usersEmail='$email'");
...
//    substr() -> qui utilise seulement un certain nombre de caractere (okdas,0,2) -> ok
                        if ($data->num_rows >0){
                            ...
                            $url = "http://localhost/REAL%20FINAL/REAL%20FINAL/Webpage/resetpassword.php?token=$str&usersEmail=$email";
                            ...
                            $connection->query("UPDATE users SET token='$str' WHERE usersEmail='$email'");
                    ...
                    <div class="button input-box">
                        ...
                        <button type="submit" name="forgotpassword" value="Resquest Password">Request Password</button>
                    </div>
